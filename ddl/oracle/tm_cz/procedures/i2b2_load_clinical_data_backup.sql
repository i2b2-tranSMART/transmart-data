--
-- Type: PROCEDURE; Owner: TM_CZ; Name: I2B2_LOAD_CLINICAL_DATA_BACKUP
--
  CREATE OR REPLACE PROCEDURE "TM_CZ"."I2B2_LOAD_CLINICAL_DATA_BACKUP"
(
...
--modified for performace
 ...
 -- execute immediate('DROP INDEX "I2B2DEMODATA"."OF_CTX_BLOB"');
  --	stepCt := stepCt + 1;
	...
	--  -- Performace fix set nologging  and modified query
